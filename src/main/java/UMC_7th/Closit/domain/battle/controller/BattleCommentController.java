...
@Tag(name = "[배틀 게시판 댓글]", description = "배틀 게시판 댓글 관련 API")
@RestController
...
public class BattleCommentController {
    ...
    @Operation(summary = "배틀 댓글 조회",
            ...
            """)
    public ApiResponse<BattleCommentResponseDTO.BattleCommentPreviewListDTO> getBattleComments(@PathVariable("battleId") Long battleId,
    ...
    @DeleteMapping("/{battleId}/comments/{battleCommentId}")
    @Operation(summary = "배틀 댓글 삭제",
            description = """
            ## 배틀 게시글 내 특정 댓글 삭제
            ### PathVariable
            battleId [배틀 ID] \n
            battleCommentId [배틀 댓글 ID]
            """)
    public ApiResponse<String> deleteBattleComment(@PathVariable("battleId") Long battleId,
                                                   @PathVariable("battleCommentId") Long battleCommentId) {
